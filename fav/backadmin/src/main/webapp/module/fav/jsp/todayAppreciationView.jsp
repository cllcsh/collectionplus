...
<table class="bg" border="0" align="center" cellpadding="0" cellspacing="0"><tr><td>
	<table class="tb_add" width="100%"  border="0" cellpadding="1" cellspacing="1">
		...
		<tr>
		    ...
		    <td width="40%"><img id="imgPathImg" src="${qnImageUrl}<s:property value="todayAppreciationForm.image"/>?imageView2/1/w/32/h/32" style="cursor: pointer;" width="32" height="32" /></td>
		</tr>
		<tr>
