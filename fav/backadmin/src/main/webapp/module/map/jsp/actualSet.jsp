...
<script type="text/javascript">
	<s:if test="%{actionName == 'actual_save'}">
		$(document).ready(function(){
			$(document).ict({
				saveForm:'setForm',
			    saveUrl:'actual_save.do',
			    saveUrlTo:'actual_init.do',
			    saveBtn:'btn_save'
			});
		});
	</s:if>
...
<s:form id="setForm" name="actualForm" action="%{actionName}">
	<s:hidden name="actualForm.id"></s:hidden>
