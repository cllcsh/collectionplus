 ...
 * 用户黑名单表
 */
@DBTable(name="tb_user_blacklist")
public class UserBlacklistBean {
    ...
    // 黑名单用户Id
    @DBField(name="blacklist_user_id")
    private BigDecimal blacklist_user_id;
    ...
    public BigDecimal getBlacklist_user_id() {
		return blacklist_user_id;
	}
	public void setBlacklist_user_id(BigDecimal blacklistUserId) {
