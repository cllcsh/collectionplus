...
$(document).ready(function(){
	$(document).ict({
		queryForm:'queryForm',
		queryUrl:'album_query.do',
		queryBtn:'btn_query',
		pagecontent:'pagecontent',
		addUrl:'album_add.do',
		delsUrl:'album_deletes.do',
		delsBtn:'btn_del'
	});	
});
</script>
	...
	<table class="tb_query" border="0" cellspacing="1" cellpadding="1" align="center" >
		<tr>
            ...
            <td colspan="3">
				<s:textfield size="20" id="title" cssClass="td03"
										name="albumForm.title" maxlength="60"
		...
		<tr>
			<td class="bottom" colspan="4" align="center">
		   		<s:if test="%{userSession.userPermissions['/module/skyshare/album_query.do'] != null}">
...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
	<tr>
		<td align="right" style="padding-right: 20px">
			<s:if test="%{userSession.userPermissions['/module/skyshare/album_add.do'] != null}">
				<input type="button" id="btn_add" class="button" value="添加"/>
			</s:if>
			<s:if test="%{userSession.userPermissions['/module/skyshare/album_deletes.do'] != null}">
...
<div id="viewDialog" title="图片预览"></div>
</body>
</html>
