...
<s:else>
	...
	<table class="tb_result" border="0" cellspacing="1" cellpadding="1" align="center">
      ...
      <tr align="center" class='<s:if test="#sta.odd">tr_odd</s:if><s:else>tr_even</s:else>'>
        ...
        <td><img src="<s:property value="#homeInfo.adImages1"/>" width="32" height="32" /></td>
		<td><img src="<s:property value="#homeInfo.adImages2"/>" width="32" height="32" /></td>
		<td><img src="<s:property value="#homeInfo.adImages3"/>" width="32" height="32" /></td>
		<td><img src="<s:property value="#homeInfo.adImages4"/>" width="32" height="32" /></td>
		<td><img src="<s:property value="#homeInfo.adImages5"/>" width="32" height="32" /></td>
		<td><img src="<s:property value="#homeInfo.adImages6"/>" width="32" height="32" /></td>
		<td><img src="<s:property value="#homeInfo.adImages7"/>" width="32" height="32" /></td>
		<td><img src="<s:property value="#homeInfo.adImages8"/>" width="32" height="32" /></td>
		<td><img src="<s:property value="#homeInfo.adImages9"/>" width="32" height="32" /></td>
