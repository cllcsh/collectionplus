...
<tr>
    <th width="20%" style="text-align:right;">分类名称<font style="color: red;">*</font>：</th>
    <td width="40%"><s:property value="collectionCategoryForm.categoryName"/></td>
</tr>
<tr>
    <th width="20%" style="text-align:right;">显示顺序<font style="color: red;">*</font>：</th>
    <td width="40%"><s:property value="collectionCategoryForm.displayOrder"/></td>
</tr>
