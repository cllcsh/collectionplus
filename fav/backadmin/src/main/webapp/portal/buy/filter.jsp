...
<body>
    ...
    <div class="comm-white-ctn">
        <div class="container">
            ...
            <s:hidden name="carForm.title"></s:hidden>
			<div class="mod-buy-brand-filter clearfix">
                ...
                <span class="select">
                	<s:select onchange="versionChange();" cssClass="current" id="carVersionId" name="carForm.versionId" listKey="id" listValue="name" list="carVersionInfoList" headerKey="0" headerValue="全部版本"></s:select>
                </span>
                <span class="split comm-text-lightgray">&gt;</span>
                <span class="select">
                	<s:select onchange="seriesChange();" cssClass="current" id="seriesId" name="carForm.seriesId" listKey="id" listValue="name" list="seriesInfoList" headerKey="0" headerValue="全部系列"></s:select>
...
<%--                    </div>--%>
                ...
                <span class="split comm-text-lightgray">&gt;</span>
                <span class="select">
                	<s:select onchange="modelsChange();" cssClass="current" id="modelsId" name="carForm.modelsId" listKey="id" listValue="name" list="modelsInfoList" headerKey="0" headerValue="全部车型"></s:select>
...
<%--                    </div>--%>
            ...
            <div class="mod-buy-carlist">
                ...
                <div class="item">
                    <div class="inner">
                        <a href="/buy_view.do?carForm.id=<s:property value='#car.id'/>" class="img">
                        <s:if test="%{#car.modelyearInfo.picPath2 == null || #car.modelyearInfo.picPath2 == ''}">
                        ...
                        <h1 class="title"><s:property value='#car.title'/></h1>
