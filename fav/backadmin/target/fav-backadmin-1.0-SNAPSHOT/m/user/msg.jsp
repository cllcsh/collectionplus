...
<body>
    ...
    <div class="wrap" style="margin-bottom: 0;">
		...
		<s:iterator var="noticeInfo" value="%{pageList.results}">
            <a href="/muserportal_msgDetail.do?id=<s:property value='#noticeInfo.id'/>"  class="item">
                <!--<span class="bubble"></span>-->
                <div class="title"><s:property value='#noticeInfo.title'/> <div class="right comm-text-gray"><s:date name='#noticeInfo.insertDate' format="yyyy-MM-dd HH:mm"/></div></div>
