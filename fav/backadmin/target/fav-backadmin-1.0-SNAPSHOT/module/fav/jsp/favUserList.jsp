      ...
      <tr align="center" class='<s:if test="#sta.odd">tr_odd</s:if><s:else>tr_even</s:else>'>
		...
		<td width="120px;">
			<s:iterator value="#favUserInfo.userTitleImgs" id="titleImg">  
			  <img src="${qnImageUrl}<s:property value="titleImg"/>?imageView2/1/w/50/h/50"  style="width:50px;height:50px;" />
			</s:iterator> 
		</td>
		<td><img src="${qnImageUrl}<s:property value="#favUserInfo.avatar"/>?imageView2/1/w/32/h/32"  width="32" height="32" /></td>
