...
<script type="text/javascript">
	<s:if test="%{actionName == 'priceDay_save'}">
		$(document).ready(function(){
			$(document).ict({
				saveForm:'setForm',
			    saveUrl:'priceDay_save.do',
			    saveUrlTo:'priceDay_init.do',
			    saveBtn:'btn_save'
			});
		});
	</s:if>
...
<s:form id="setForm" name="priceDayForm" action="%{actionName}">
	<s:hidden name="priceDayForm.id"></s:hidden>
