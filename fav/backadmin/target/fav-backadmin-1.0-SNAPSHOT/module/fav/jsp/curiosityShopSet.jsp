					...
					<tr>
					    ...
					    <td width="40%">
					   		<s:if test="%{curiosityShopForm.icon != null && curiosityShopForm.icon != ''}">
								<img id="imgPathIconImg" src="${qnImageUrl}<s:property value='curiosityShopForm.icon'/>?imageView2/1/w/32/h/32" alt="点击编辑" style="cursor: pointer;" width="32" height="32" onclick="openDialogUploadIcon('imgPathIcon');"/>
							</s:if>
							<s:else>
