...
$(document).ready(function(){
	$(document).ict({
		queryForm:'queryForm',
		queryUrl:'modelsHot_query.do',
		queryBtn:'btn_query',
		pagecontent:'pagecontent',
		addUrl:'modelsHot_add.do',
		delsUrl:'modelsHot_deletes.do',
		delsBtn:'btn_del'
	});
	choseBrand();
});
...
<table class="bg" border="0" align="center" cellpadding="0" cellspacing="0"><tr><td>
	<table class="tb_query" border="0" cellspacing="1" cellpadding="1" align="center" >
		...
		<tr>
			...
			<td>
				<select id="modelsId" name="modelsHotForm.modelsId">
		...
		<tr>
			<td class="bottom" colspan="4" align="center">
		   		...
		   		<s:if test="%{userSession.userPermissions['/module/gxfc/modelsHot_query.do'] != null}">
					<input name="btn" id="btn_query" type="button" class="button" value="查询" />
		   		</s:if>
