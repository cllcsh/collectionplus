...
<script type="text/javascript">
	<s:if test="%{actionName == 'userAction_save'}">
		$(document).ready(function(){
			$(document).ict({
				saveForm:'setForm',
			    saveUrl:'userAction_save.do',
			    saveUrlTo:'userAction_init.do',
			    saveBtn:'btn_save'
			});
		});
	</s:if>
...
<s:form id="setForm" name="userActionForm" action="%{actionName}">
	<s:hidden name="userActionForm.id"></s:hidden>
