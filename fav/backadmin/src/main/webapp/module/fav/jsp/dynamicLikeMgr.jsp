...
$(document).ready(function(){
	$(document).ict({
		queryForm:'queryForm',
		queryUrl:'dynamicLike_query.do',
		queryBtn:'btn_query',
		pagecontent:'pagecontent',
		addUrl:'dynamicLike_add.do',
		delsUrl:'dynamicLike_deletes.do',
		delsBtn:'btn_del'
	});
});
</script>
...
<table class="bg" border="0" align="center" cellpadding="0" cellspacing="0"><tr><td>
	<table class="tb_query" border="0" cellspacing="1" cellpadding="1" align="center" >
		<tr>
		    <th>动态</th>
		    <td><s:textfield size="25" id="dynamicContent" name="dynamicLikeForm.dynamicContent" onblur="clearBlank(this);" maxlength="60"  /></td>
		    <th>好友用户</th>
		    <td><s:textfield size="25" id="friendName" name="dynamicLikeForm.friendName" onblur="clearBlank(this);" maxlength="60"  /></td>
		</tr>
		<tr>
		    <th>点赞时间</th>
		    <td width="35%">
		...
		<tr>
			<td class="bottom" colspan="4" align="center">
		   		...
		   		<s:if test="%{userSession.userPermissions['/module/fav/dynamicLike_query.do'] != null}">
					<input name="btn" id="btn_query" type="button" class="button" value="查询" />
		   		</s:if>
...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
	<tr>
		<td align="right" style="padding-right: 20px">
			...
			<s:if test="%{userSession.userPermissions['/module/fav/dynamicLike_add.do'] != null}">
				<input type="button" id="btn_add" class="button" value="添加"/>
			</s:if>-->
			<input type="button" id="btn_del" class="button" value="删除"/>
			<s:if test="%{userSession.userPermissions['/module/fav/dynamicLike_deletes.do'] != null}">
				<input type="button" id="btn_del" class="button" value="删除"/>
			</s:if>
		</td>
	</tr>
