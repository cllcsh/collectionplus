...
<script type="text/javascript">
	<s:if test="%{actionName == 'orderFlow_save'}">
		$(document).ready(function(){
			$(document).ict({
				saveForm:'setForm',
			    saveUrl:'orderFlow_save.do',
			    saveUrlTo:'orderFlow_init.do',
			    saveBtn:'btn_save'
			});
		});
	</s:if>
...
<s:form id="setForm" name="orderFlowForm" action="%{actionName}">
	<s:hidden name="orderFlowForm.id"></s:hidden>
