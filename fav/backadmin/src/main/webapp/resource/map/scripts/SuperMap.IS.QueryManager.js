...
// 版 本:  $Id: SuperMap.IS.QueryManager.js,v 1.17.2.2 2009/09/23 04:57:08 zhangyt Exp $
// 文 件:  SuperMap.IS.QueryManager.js 
// 描 述:  AjaxScripts 查询功能 
// 更 新:  $Date: 2009/09/23 04:57:08 $ 
//================================================================================ 
...
SuperMap.IS.QueryManager=function(mapHandler,mapName,trackingLayerIndex,userID){
    ...
    function _QueryBase(methodName, paramNames, paramValues,onComplete,onError,userContext){
		...
		function onRequestComplete(responseText){
		    var resultSetJ=_eval('('+responseText+')');
...
//        _QueryBase("ExecuteGSQL",["gsql","highlight"],[gsql,highlight],onComplete,onError,userContext);
//    }
