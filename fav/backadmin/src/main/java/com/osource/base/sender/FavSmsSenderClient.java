 ...
 * 
 */
public class FavSmsSenderClient {
    private static Logger logger = LoggerFactory.getLogger(FavSmsSenderClient.class);
    ...
    public static void main(String[] args) {
		System.out.println(FavSmsSenderClient.sendSms("15950519371","验证码fav2221","2"));
	}
}