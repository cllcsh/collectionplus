...
<script type="text/javascript">
	<s:if test="%{actionName == 'brandHot_save'}">
		$(document).ready(function(){
			$(document).ict({
				saveForm:'setForm',
			    saveUrl:'brandHot_save.do',
			    saveUrlTo:'brandHot_init.do',
			    saveBtn:'btn_save'
			});
			choseBrand();
		});
...
<s:form id="setForm" name="brandHotForm" action="%{actionName}">
	<s:hidden name="brandHotForm.id"></s:hidden>
				...
				<table class="tb_add" width="100%" border="0" cellpadding="1" cellspacing="1">
					<tr>
						...
						<td width="40%">
							...
							<select id="brandId" name="brandHotForm.brandId"></select>
							</s:if>
							<s:else>
							<s:property value="brandHotForm.brandName"/>
							<s:hidden name="brandHotForm.brandId"></s:hidden>
							</s:else>
						</td>
					...
					<tr>
						...
						<td width="40%"><s:textfield name="brandHotForm.sorting"></s:textfield></td>
						<td width="40%">&nbsp;</td>
					</tr>
					<tr>
