...
<table class="bg" border="0" align="center" cellpadding="0" cellspacing="0"><tr><td>
	<table class="tb_add" width="100%"  border="0" cellpadding="1" cellspacing="1">
		<tr>
		    ...
		    <td width="40%"><s:property value="dynamicImagesForm.dynamicId"/></td>
		</tr>
		<tr>
		    <th width="20%" style="text-align:right;">上传图片地址<font style="color: red;">*</font>：</th>
		    <td width="40%">${qnImageUrl}<s:property value="dynamicImagesForm.image"/></td>
		</tr>
		<tr>
		    <th width="20%" style="text-align:right;">显示顺序<font style="color: red;">*</font>：</th>
		    <td width="40%"><s:property value="dynamicImagesForm.displayOrder"/></td>
		</tr>
