...
public class ConverterFactory
{
	...
	public void loadExternalConverter(String typeClass, String converterClass)
	{
		...
		{
			System.out.println("Cannot load converter '" + converterClass + "' for type '" + typeClass + "'." + e.getMessage());
		}
	}
	...
	public void loadExternalConverter(Class<?> clazz, Converter<?> converter)
	{
		...
		{
			System.out.println("Cannot replace the exist converter for type '" + clazz.getName() + "'.");
			return;
		}
