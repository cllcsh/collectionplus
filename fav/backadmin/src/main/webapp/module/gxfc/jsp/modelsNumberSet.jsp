...
<script type="text/javascript">
	<s:if test="%{actionName == 'modelsNumber_save'}">
		$(document).ready(function(){
			$(document).ict({
				saveForm:'setForm',
			    saveUrl:'modelsNumber_save.do',
			    saveUrlTo:'modelsNumber_init.do',
			    saveBtn:'btn_save'
			});
		});
	</s:if>
	<s:else>
		$(document).ready(function(){
			$(document).ict({
				saveForm:'setForm',
			    saveUrl:'modelsNumber_update.do',
			    saveUrlTo:'modelsNumber_init.do',
			    saveBtn:'btn_save'
			});
		});
...
<s:form id="setForm" name="modelsNumberForm" action="%{actionName}">
