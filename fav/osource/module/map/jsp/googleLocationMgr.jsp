...
<script type="text/javascript">	
	...
	{
		var picurl = "images/locationImage.gif";
		var remark = getRemark(dataObj.locId, dataObj.name, dataObj.locNum, dataObj.rectifyLong, dataObj.rectifyLat, dataObj.placeName, dataObj.locDate, dataObj.radius, dataObj.posour,dataObj.pic_path);
		//alert(remark);
		placeMarker({lat:dataObj.rectifyLat, lng:dataObj.rectifyLong}, $map, {image:picurl,title:"loc_"+dataObj.locId}, true, {content:remark});
	}
...
<div class="bg100">
	<table class="tb_query" border="0" cellspacing="1" cellpadding="1" align="center" >
		...
		<tr>
			<td width="50%"><ict:select beanContextId="deptSelect" id="deptId" name="locaQueryForm.deptId" emptyOption="true" cssStyle="width:100%"/></td>
			<td width="50%">
