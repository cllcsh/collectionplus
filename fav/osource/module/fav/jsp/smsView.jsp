...
<table class="bg" border="0" align="center" cellpadding="0" cellspacing="0"><tr><td>
	<table class="tb_add" width="100%"  border="0" cellpadding="1" cellspacing="1">
		<tr>
		    ...
		    <td width="40%"><s:property value="smsForm.phone"/></td>
		</tr>
		<tr>
		    <th width="20%" style="text-align:right;">短信内容<font style="color: red;">*</font>：</th>
		    <td width="40%"><s:property value="smsForm.content"/></td>
		</tr>
        <tr>
