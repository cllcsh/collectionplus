...
$(document).ready(function(){
	$(document).ict({
		queryForm:'queryForm',
		queryUrl:'notice_query.do',
		queryBtn:'btn_query',
		pagecontent:'pagecontent',
		addUrl:'notice_add.do',
		delsUrl:'notice_deletes.do',
		delsBtn:'btn_del'
	});
});
</script>
	...
	<table class="tb_query" border="0" cellspacing="1" cellpadding="1" align="center" >
		...
		<tr>
			<td class="bottom" colspan="4" align="center">
		   		...
		   		<s:if test="%{userSession.userPermissions['/module/system/notice_query.do'] != null}">
					<input name="btn" id="btn_query" type="button" class="button" value="查询" />
		   		</s:if>
...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
	<tr>
		<td align="right" style="padding-right: 20px">
			...
			<s:if test="%{userSession.userPermissions['/module/system/notice_add.do'] != null}">
				<input type="button" id="btn_add" class="button" value="添加"/>
			</s:if>
			<input type="button" id="btn_del" class="button" value="删除"/>
			<s:if test="%{userSession.userPermissions['/module/system/notice_deletes.do'] != null}">
				<input type="button" id="btn_del" class="button" value="删除"/>
			</s:if>
		</td>
	</tr>
