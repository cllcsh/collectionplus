					...
					<tr>
					    ...
					    <td width="40%">
					    	<s:if test="%{todayAppreciationForm.image != null && todayAppreciationForm.image != ''}">
								<img id="imgPathImg" src="${qnImageUrl}<s:property value='todayAppreciationForm.image'/>?imageView2/1/w/32/h/32" alt="点击编辑" style="cursor: pointer;" width="32" height="32" onclick="openDialogUpload('imgPath');"/>
							</s:if>
							<s:else>
