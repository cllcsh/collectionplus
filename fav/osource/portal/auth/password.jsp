...
<body>
    ...
    <div class="comm-white-ctn">
        ...
        <div class="module-auth-reg-form">
            <div class="container">
                <form id="regForm" action="/home_login.do" method="post">
                    ...
                    <div class="form-group">
                        <button type="button" class="button button-primary submit" onclick="validCode();">重置密码</button>
                    </div>
                </form>
            </div>
        </div>
...
function sendAuthCode() {
	...
	$.ajax({
		type: "POST",
		url: "/home_validPasswordPhone.do",
		data: {"mobile":mobile},
...
function validCode() {
	...
	$.ajax({
		...
		success: function(data){
			...
			{
				window.location.href='/home_login.do';
			}
		},
		error: function(XMLHttpRequest, textStatus, errorThrown){
			//alert("保存失败");
