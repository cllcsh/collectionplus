<%@page contentType="text/html; charset=UTF-8"%>
    ...
    <div class="comm-fixed-bar">
        <div class="container clearfix">
            <div class="left">
                ...
                <a href="#">收藏本站</a>
                <span class="split">|</span>
                咨询电话：<i><a href="#"><span class="comm-img phone"></span> 400 - 123 - 4567</a></i>
            </div>
            <div class="right">
				 ...
				 <s:else>
					 ...
					 <s:property value="userSession.userName"/><span class="comm-text-red">(已冻结)</span>
							...
							<div class="submenu">
								...
								<!--<a href="userportal_msg.do" class="item"><i class="comm-img msg"></i>通知消息 <span class="bubble">5</span></a>-->
    ...
    <div class="comm-header-ctn">
        <div class="container clearfix">
            ...
            <div class="searcher">
                <div class="text">今日共有<span class="comm-text-red">10</span>个品牌，<span class="comm-text-red">3900</span>款型号车上线</div>
                <form action="/home.do" class="search-form">
                    <div class="input"><span class="placeholder"><i class="comm-img search"></i>搜索您想找的汽车型号</span><input id="J-SearchIpt" type="text" placeholder=""></div>
                ...
                <div class="brands">
                	...
                	<a href="#"><s:property value="brandName"/></a>
                	</s:if>
                	</s:iterator>
                </div>
            </div>
