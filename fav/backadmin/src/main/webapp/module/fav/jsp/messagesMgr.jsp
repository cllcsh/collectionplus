...
$(document).ready(function(){
	$(document).ict({
		queryForm:'queryForm',
		queryUrl:'messages_query.do',
		queryBtn:'btn_query',
		pagecontent:'pagecontent',
		addUrl:'messages_add.do',
		delsUrl:'messages_deletes.do',
		delsBtn:'btn_del'
	});
});
</script>
...
<table class="bg" border="0" align="center" cellpadding="0" cellspacing="0"><tr><td>
	<table class="tb_query" border="0" cellspacing="1" cellpadding="1" align="center" >
		<tr>
		    <th>发送人</th>
		    <td><s:textfield size="25" id="sender" name="messagesForm.senderName" onblur="clearBlank(this);" maxlength="60"  /></td>
		    <th>接收人</th>
		    <td><s:textfield size="25" id="receiver" name="messagesForm.receiverName" onblur="clearBlank(this);" maxlength="60"  /></td>
		</tr>
		<tr>
		    <th width="15%">发送时间</th>
		    <td width="35%">
		    ...
		    <th>消息内容</th>
		    <td><s:textfield size="25" id="content" name="messagesForm.content" onblur="clearBlank(this);" maxlength="60"  /></td>
		</tr>
		<tr>
		    <th>是否已读</th>
		    <td>
		    	<s:select id="isRead" name="messagesForm.isRead" list="readMap" listKey="key" listValue="value" headerKey="-1" headerValue="所有" cssStyle="width:180px"/>
		    </td>
		    <th></th>
		    <td></td>
		</tr>
		...
		<tr>
			<td class="bottom" colspan="4" align="center">
		   		...
		   		<s:if test="%{userSession.userPermissions['/module/fav/messages_query.do'] != null}">
					<input name="btn" id="btn_query" type="button" class="button" value="查询" />
		   		</s:if>
...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
	<tr>
		<td align="right" style="padding-right: 20px">
			...
			<s:if test="%{userSession.userPermissions['/module/fav/messages_add.do'] != null}">
				<input type="button" id="btn_add" class="button" value="添加"/>
			</s:if>-->
			<input type="button" id="btn_del" class="button" value="删除"/>
			<s:if test="%{userSession.userPermissions['/module/fav/messages_deletes.do'] != null}">
				<input type="button" id="btn_del" class="button" value="删除"/>
			</s:if>
		</td>
	</tr>
