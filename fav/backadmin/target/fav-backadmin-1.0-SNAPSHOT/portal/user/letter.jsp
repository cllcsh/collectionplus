...
<head>
    ...
    <style>
    	.mod-user-msg-list {margin:0 0 0 0;}
    </style>
</head>
<body>
    ...
    <div class="comm-white-ctn">
        <div class="container">
            ...
            <div class="mod-user-main">
                <div class="mod-user-section-title">站内信</div>
                <div class="mod-user-msg-list">
				<s:iterator var="letterUserInfo" value="%{pageList.results}">
                    <a href="/userportal_letterDetail.do?id=<s:property value='#letterUserInfo.id'/>" class="item">
                        <s:if test="#letterUserInfo.lookStatus==0"><span class="bubble"></span></s:if>
                        <div class="title">
                        	<s:property value='#letterUserInfo.title'/> 
                        	<div class="right comm-text-lightgray">
                        		<s:date name='#letterUserInfo.insertDate' format="yyyy-MM-dd HH:mm"/>
                        	</div>
                        </div>
                        <div class="body comm-text-gray"><s:property escape="false" value='#letterUserInfo.content'/></div>
                    </a>
				</s:iterator>
                </div>
            </div>
