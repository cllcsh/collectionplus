...
$(document).ready(function(){
	$(document).ict({
		queryForm:'queryForm',
		queryUrl:'sms_query.do',
		queryBtn:'btn_query',
		pagecontent:'pagecontent',
		addUrl:'sms_add.do',
		delsUrl:'sms_deletes.do',
		delsBtn:'btn_del'
	});
});
</script>
...
<table class="bg" border="0" align="center" cellpadding="0" cellspacing="0"><tr><td>
	<table class="tb_query" border="0" cellspacing="1" cellpadding="1" align="center" >
		<tr>
		    <th>手机号</th>
		    <td><s:textfield size="25" id="phone" name="smsForm.phone" onblur="clearBlank(this);" maxlength="60"  /></td>
		    <th>短信内容</th>
		    <td><s:textfield size="25" id="content" name="smsForm.content" onblur="clearBlank(this);" maxlength="60"  /></td>
		</tr>
		<tr>
		    <th width="15%">发送时间</th>
		    <td width="35%">
		...
		<tr>
			<td class="bottom" colspan="4" align="center">
		   		...
		   		<s:if test="%{userSession.userPermissions['/module/fav/sms_query.do'] != null}">
					<input name="btn" id="btn_query" type="button" class="button" value="查询" />
		   		</s:if>
...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
	<tr>
		<td align="right" style="padding-right: 20px">
			...
			<s:if test="%{userSession.userPermissions['/module/fav/sms_add.do'] != null}">
				<input type="button" id="btn_add" class="button" value="添加"/>
			</s:if>-->
			<input type="button" id="btn_del" class="button" value="删除"/>
			<s:if test="%{userSession.userPermissions['/module/fav/sms_deletes.do'] != null}">
				<input type="button" id="btn_del" class="button" value="删除"/>
			</s:if>
		</td>
	</tr>
