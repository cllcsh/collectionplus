...
import org.express.common.cache.CacheManager;
...
public class QueryHelper
{
	...
	private final static MapListHandler _g_apListHandler=new MapListHandler();
	...
	public static  List<Map<String,Object>> query(String sql, Object... params)
	{
		try
		{
			return _g_runner.query(getConnection(), sql, _g_apListHandler, params);
		}
		catch (SQLException e)
		{
			throw new DBException(e);
