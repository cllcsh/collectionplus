...
<script type="text/javascript">
	<s:if test="%{actionName == 'letterUser_save'}">
		$(document).ready(function(){
			$(document).ict({
				saveForm:'setForm',
			    saveUrl:'letterUser_save.do',
			    saveUrlTo:'letterUser_init.do',
			    saveBtn:'btn_save'
			});
		});
	</s:if>
...
<s:form id="setForm" name="letterUserForm" action="%{actionName}">
	<s:hidden name="letterUserForm.id"></s:hidden>
