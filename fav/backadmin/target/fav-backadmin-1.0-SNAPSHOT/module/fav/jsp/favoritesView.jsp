...
<table class="bg" border="0" align="center" cellpadding="0" cellspacing="0"><tr><td>
	<table class="tb_add" width="100%"  border="0" cellpadding="1" cellspacing="1">
		<tr>
		    <th width="20%" style="text-align:right;">收藏人id<font style="color: red;">*</font>：</th>
		    <td width="40%"><s:property value="favoritesForm.userId"/></td>
		</tr>
		<tr>
		    <th width="20%" style="text-align:right;">藏品id<font style="color: red;">*</font>：</th>
		    <td width="40%"><s:property value="favoritesForm.collectionId"/></td>
		</tr>
		<tr>
		    <th width="20%" style="text-align:right;">收藏时间<font style="color: red;">*</font>：</th>
		    <td width="40%"><s:property value="favoritesForm.favoriteTime"/></td>
		</tr>
