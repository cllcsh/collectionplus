...
<table class="bg" border="0" align="center" cellpadding="0" cellspacing="0"><tr><td>
	<table class="tb_add" width="100%"  border="0" cellpadding="1" cellspacing="1">
		<tr>
		    <th width="20%" style="text-align:right;">类型名称<font style="color: red;">*</font>：</th>
		    <td width="40%"><s:property value="heatForm.nameDesc"/></td>
		</tr>
		<tr>
		    <th width="20%" style="text-align:right;">系数<font style="color: red;">*</font>：</th>
		    <td width="40%"><s:property value="heatForm.value"/></td>
		</tr>
