...
<tr class="tr_head" align="center">
      ...
      <tr align="center" class='<s:if test="#sta.odd">tr_odd</s:if><s:else>tr_even</s:else>'>
		<td>
			<input name="checkbox2" type="checkbox" class="ckboxItem" value="<s:property value="#product.id"/>" onclick="check('checkboxtop','checkbox2');checkAdd(this,<s:property value='#product.id'/>);" />
		</td>
        <td>
