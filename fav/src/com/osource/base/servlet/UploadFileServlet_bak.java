...
public class UploadFileServlet_bak extends HttpServlet {
	private static Logger log = Logger.getLogger(UploadFileServlet_bak.class);
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if(glFlag != null && glFlag.equals("1")){
		...
		try {
			if (fname.startsWith("http://")) {
				...
				result = fname.substring(fname
						.indexOf(UploadFileServlet_bak.SBPATH));
