    ...
    <tr>
        <td>
            <table class="tb_add" width="100%"  border="0" cellpadding="1" cellspacing="1">
                <tr>
                    <th width="20%" style="text-align:right;">时期名称<font style="color: red;">*</font>：</th>
                    <td width="40%"><s:property value="collectionPeriodForm.name"/></td>
                </tr>
                <tr>
                    <th width="20%" style="text-align:right;">显示顺序<font style="color: red;">*</font>：</th>
                    <td width="40%"><s:property value="collectionPeriodForm.displayOrder"/></td>
                </tr>
                <tr>
                    <th width="20%" style="text-align:right;">上传图片<font style="color: red;">*</font>：</th>
                    <td width="40%"><img src="${qnImageUrl}<s:property value="collectionPeriodForm.imageUrl"/>?imageView2/1/w/32/h/32" width="32" height="32" /></td>
                </tr>
                <tr>
