...
<script type="text/javascript">
	<s:if test="%{actionName == 'baseprice_save'}">
		$(document).ready(function(){
			$(document).ict({
				saveForm:'setForm',
			    saveUrl:'baseprice_save.do',
			    saveUrlTo:'baseprice_init.do',
			    saveBtn:'btn_save'
			});
		});
	</s:if>
...
<s:form id="setForm" name="basepriceForm" action="%{actionName}">
	<s:hidden name="basepriceForm.id"></s:hidden>
