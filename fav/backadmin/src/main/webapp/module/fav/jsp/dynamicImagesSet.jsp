			...
			<td>
				<table class="tb_add" width="100%" border="0" cellpadding="1" cellspacing="1">
					...
					<tr>
					    ...
					    <td width="40%">
					        <input type="text" class="easyui-validatebox" data-options="required:true" name="dynamicImagesForm.image" value="${qnImageUrl}<s:property value="dynamicImagesForm.image"/>"/>
					    </td>
					</tr>
					<tr>
